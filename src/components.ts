...
import { defineCustomElements } from '@rhazn/logic-components/loader';

defineCustomElements();
export const CreateSyntax = /*@__PURE__*/createReactComponent<JSX.CreateSyntax, HTMLCreateSyntaxElement>('create-syntax');
